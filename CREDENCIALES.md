...
| `DIMAS_RAMOS` | `dimas2025` | ADMIN_CONTROL | TRACKER | RH |
...
> Movimiento de departamento: `CARLOS_MENDEZ` pasó de CONSTRUCCION a CALIDAD. `DIMAS_RAMOS` pasó de EHS a RH. Re-alta: `LILIANA_MARTINEZ` (RH), `LAURA_HUERTA` (RH), `ROCIO_CASTRO` (FINANZAS).
