...
| `DANIA_GONZALEZ` | `dania2322` | STAFF_USER | TRACKER | FACTURACION |
| `JUANY_RODRIGUEZ` | `juany2814` | STAFF_USER | TRACKER | FINANZAS |
...
| `SAIRA` | `saira3725` | STAFF_USER | TRACKER | FACTURACION |
...
> Movimiento de departamento: `CARLOS_MENDEZ` pasó de CONSTRUCCION a CALIDAD.

> Bajas (eliminados de USER_DB): `SELENE_BALDONADO`, `MIGUEL_GONZALEZ`, `ALICIA_RIVERA`, `NELSON_MALDONADO`, `VICTOR_ALMACEN`, `ANTONIO_SALAZAR`, `ROCIO_CASTRO`, `LAURA_HUERTA`, `LILIANA_MARTINEZ`, `DANIELA_CASTRO`, `ANTONIO_CABRERA`.
